  ...
  <div class="container mt-3">
    <div class="row">
      <div class="col">
        ...
        <p class="fst-italic">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum aperiam ullam facere, asperiores sint enim numquam iusto ut, neque minus soluta eaque nesciunt repellat aliquid corrupti quas tenetur? Perferendis, laboriosam!</p>
        <form>
          <div class="row">
            <div class="col-md-6">
              <div class="row">
      ...
      methods : {
        clickDeleteContact : async function(contactId){
          try {
            ...
            if(response){
              this.loading = true;
              let response = await ContactService.getAllContacts(); //refresh data
              this.contacts = response.data;
              this.loading = false;
            }
          } catch (error) {
